...
// HW interrupts are numbers 16 to 255 on this MCU
pp_forloop(i, 16, 255, ISR_NULL(i)` ')
...
void (*isr_vector[])(void) __attribute__((section(".isr_vector"))) = {
    ...
    // hardware interrupts (numbers 16 to 255 on this MCU)
    pp_forloop(i, 16, 255, INTFN(i)`, ')
};
